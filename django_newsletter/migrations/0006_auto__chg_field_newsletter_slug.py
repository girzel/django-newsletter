...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('newsletter_newsletter', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Newsletter.slug'
        db.alter_column('newsletter_newsletter', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
